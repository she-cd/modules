...
int
recv_ext(int s, void *mem, size_t len)
{
	return (int)lwip_recv(s, mem, len, 0);
}
...
int
send_ext(int s, const void *data, size_t size)
{
...
{
	if ((maxfdp1 < 0) || (maxfdp1 > FD_SETSIZE))  return -1;
