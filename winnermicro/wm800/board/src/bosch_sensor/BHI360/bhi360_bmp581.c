...
#define BHI360_DEV_ADDR         0x50

#define BHY2_REG_PRODUCT_ID                       0x1C
/******************************************************************************/
/*!            Functions                                                      */

int wm_bhi3_read_i2c(uint8_t dev_addr, uint8_t addr, uint8_t *buf, uint32_t len)
{
...
int bhi360_read_sensor_data(void)
{
    uint8_t reg_data = 0;
    ...
    wm_bhi3_read_i2c(BHI360_DEV_ADDR, BHY2_REG_PRODUCT_ID, &reg_data, 1);
}

//SYS_RUN(bhi360_read_sensor_data);
#endif
...
#include "bhi360/BHI360_BMM150_BMP580_BME688.fw.h"

#define WORK_BUFFER_SIZE  2048

#define QUAT_SENSOR_ID    BHY2_SENSOR_ID_TEMP
